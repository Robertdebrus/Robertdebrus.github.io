...
//  Scroll Down
var rect6Xmin = 0.625 * windowWidth;
...
function canvasClear(canvasId){
	var c=document.getElementById("canvasEyeUp"); 
    if (c = undefined) {
    }
    else {
...
//	canvasClear("canvasEyeDown");	
	...
	drawLine("canvasEyeDown","#00aaff",5,0,0,150,75,300,0);
		...
		d = (rect7Ymax);
	if (x < b && x > a && y < d && y > c){
			drawRectfill("canvasEyeUp",rect7Xmin,rect7Ymin,rect7Xmax,rect7Ymax,"#33adff");
	...
	d = (rect1Ymax);
	if (x < b && x > a && y < d && y > c){
			drawRectfill("canvasEyeDown",rect1Xmin,rect1Ymin,rect1Xmax,rect1Ymax,"#33adff");
